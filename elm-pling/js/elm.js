...
var _user$project$Matrix$t3 = A2(
	...
	A2(
		...
		A2(
			_elm_lang$core$Array$push,
			_elm_lang$core$Array$fromList(
				_elm_lang$core$Native_List.range(2, 6)),
...
var _user$project$Matrix$map = function (f) {
	return _elm_lang$core$Array$map(
		function (a) {
			return A2(_elm_lang$core$Array$map, f, a);
		});
};
var _user$project$Matrix$fold = F3(
	function (f, b, mat) {
		return A3(
			_elm_lang$core$Array$foldl,
			F2(
				function (a, bs) {
					return A3(_elm_lang$core$Array$foldl, f, bs, a);
				}),
			b,
			mat);
	});
...
var _user$project$Matrix$getY = function (y) {
	return A2(
		_elm_lang$core$Array$foldl,
		F2(
			function (x, a) {
				return A3(
					...
					_elm_lang$core$Array$push,
					A2(_elm_lang$core$Array$get, y, x),
					a);
			}),
...
var _user$project$Matrix$length = function (mat) {
	var b = _elm_lang$core$Array$length(
		A2(
			_elm_lang$core$Maybe$withDefault,
			_elm_lang$core$Array$empty,
			A2(_elm_lang$core$Array$get, 0, mat)));
	var a = _elm_lang$core$Array$length(mat);
...
var _user$project$Pling$toggle = F2(
	function (pos, matrix) {
		var _p0 = A2(_user$project$Matrix$get, pos, matrix);
		if (_p0.ctor === 'Just') {
			if (_p0._0 === true) {
				return A3(_user$project$Matrix$set, pos, false, matrix);
			} else {
				return A3(_user$project$Matrix$set, pos, true, matrix);
			}
		} else {
			return A3(_user$project$Matrix$set, pos, false, matrix);
		}
					...
					return _elm_lang$core$Json_Encode$object(
						_elm_lang$core$Native_List.fromArray(
							[
								...
								ctor: '_Tuple2',
								_0: 'tone',
								_1: _elm_lang$core$Json_Encode$int(i)
							}
							]));
				},
				A2(
					...
					function (_p2) {
						var _p3 = _p2;
						return _elm_lang$core$Native_Utils.eq(_p3._1, true) ? _elm_lang$core$Maybe$Just(_p3._0) : _elm_lang$core$Maybe$Nothing;
					},
					_elm_lang$core$Array$toIndexedList(_p1._0))));
	} else {
			...
			case 'Click':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							matrix: A2(_user$project$Pling$toggle, _p4._0, model.matrix)
						}),
			...
			case 'UpdatePlay':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							currentCol: _user$project$Pling$next(model.currentCol)
						}),
					_1: _user$project$Pling$playNotes(
						A2(
							_elm_lang$core$Json_Encode$encode,
							0,
							_user$project$Pling$play(model)))
				};
			case 'IsPlaying':
				return {
					ctor: '_Tuple2',
...
var _user$project$Pling$UpdatePlay = function (a) {
...
var Elm = {};
Elm['Pling'] = Elm['Pling'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Pling'], 'Pling', typeof _user$project$Pling$main === 'undefined' ? null : _user$project$Pling$main);
